# better-groupcache
```
ok      github.com/Hawk-Zhou/better-groupcache  2.514s  coverage: 84.5% of statements   
ok      github.com/Hawk-Zhou/better-groupcache/consistentHash   0.122s  coverage: 93.2% of statements
?       github.com/Hawk-Zhou/better-groupcache/geecachepb       [no test files] 	// generated by protobuf
ok      github.com/Hawk-Zhou/better-groupcache/lru_k    0.002s  coverage: 100.0% of statements
?       github.com/Hawk-Zhou/better-groupcache/main     [no test files] 		// this sets up a server for testing
ok      github.com/Hawk-Zhou/better-groupcache/singleflight     1.003s  coverage: 100.0% of statements
```
## What is this
